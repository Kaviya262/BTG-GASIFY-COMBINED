...
function* fetchEvents() {
  try {
    ...
    yield put(getEventsFail(error.message || error.toString() || 'An error occurred'));
  }
}
...
function* onAddNewEvent({ payload: event }) {
  try {
    ...
    yield put(addEventFail(error.message || error.toString() || 'An error occurred'));
  }
}
...
function* onUpdateEvent({ payload: event }) {
  try {
    ...
    yield put(updateEventFail(error.message || error.toString() || 'An error occurred'));
  }
}
...
function* onDeleteEvent({ payload: event }) {
  try {
    ...
    yield put(deleteEventFail(error.message || error.toString() || 'An error occurred'));
  }
}
...
function* onGetCategories() {
  try {
    ...
    yield put(getCategoriesFail(error.message || error.toString() || 'An error occurred'));
  }
}
