...
function* fetchInboxMails() {
  try {
    ...
    yield put(getInboxMailsFail(error.message || error.toString() || 'An error occurred'))
  }
}
...
function* fetchStarredMails() {
  try {
    ...
    yield put(getStarredMailsFail(error.message || error.toString() || 'An error occurred'))
  }
}
...
function* fetchImportantMails() {
  try {
    ...
    yield put(getImportantMailsFail(error.message || error.toString() || 'An error occurred'))
  }
}
...
function* fetchDraftMails() {
  try {
    ...
    yield put(getDraftMailsFail(error.message || error.toString() || 'An error occurred'))
  }
}
...
function* fetchSentMails() {
  try {
    ...
    yield put(getSentMailsFail(error.message || error.toString() || 'An error occurred'))
  }
}
...
function* fetchTrashMails() {
  try {
    ...
    yield put(getTrashMailsFail(error.message || error.toString() || 'An error occurred'))
  }
}
...
function* onAddNewInboxMail({ payload: inboxmail }) {
  try {
    ...
    yield put(addInboxMailFail(error.message || error.toString() || 'An error occurred'))
  }
}
...
function* onDeleteInboxMail({ payload: inboxmail }) {
  try {
    ...
    yield put(deleteInboxMailFail(error.message || error.toString() || 'An error occurred'))
  }
}
