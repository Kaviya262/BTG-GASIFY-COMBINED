...
function* fetchProducts() {
  try {
    ...
    yield put(getProductsFail(error.message || error.toString() || 'An error occurred'))
  }
}
...
function* fetchProductDetail({ productId }) {
  try {
    ...
    yield put(getProductDetailFail(error.message || error.toString() || 'An error occurred'))
  }
}
...
function* fetchOrders() {
  try {
    ...
    yield put(getOrdersFail(error.message || error.toString() || 'An error occurred'))
  }
}
...
function* onAddNewOrder({ payload: order }) {
  try {
    ...
    yield put(addOrderFail(error.message || error.toString() || 'An error occurred'))
  }
}
...
function* onUpdateOrder({ payload: order }) {
  try {
    ...
    yield put(updateOrderFail(error.message || error.toString() || 'An error occurred'))
  }
}
...
function* onDeleteOrder({ payload: order }) {
  try {
    ...
    yield put(deleteOrderFail(error.message || error.toString() || 'An error occurred'))
  }
}
...
function* fetchCartData() {
  try {
    ...
    yield put(getCartDataFail(error.message || error.toString() || 'An error occurred'))
  }
}
...
function* fetchCustomers() {
  try {
    ...
    yield put(getCustomersFail(error.message || error.toString() || 'An error occurred'))
  }
}
...
function* fetchShops() {
  try {
    ...
    yield put(getShopsFail(error.message || error.toString() || 'An error occurred'))
  }
}
...
function* onAddNewCustomer({ payload: customer }) {
  try {
    ...
    yield put(addCustomerFail(error.message || error.toString() || 'An error occurred'))
  }
}
...
function* onUpdateCustomer({ payload: customer }) {
  try {
    ...
    yield put(updateCustomerFail(error.message || error.toString() || 'An error occurred'))
  }
}
...
function* onDeleteCustomer({ payload: customer }) {
  try {
    ...
    yield put(deleteCustomerFail(error.message || error.toString() || 'An error occurred'))
  }
}
