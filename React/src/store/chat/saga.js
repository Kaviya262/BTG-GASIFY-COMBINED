...
function* onGetChats() {
  try {
    ...
    yield put(getChatsFail(error.message || error.toString() || 'An error occurred'))
  }
}
...
function* onGetGroups() {
  try {
    ...
    yield put(getGroupsFail(error.message || error.toString() || 'An error occurred'))
  }
}
...
function* onGetContacts() {
  try {
    ...
    yield put(getContactsFail(error.message || error.toString() || 'An error occurred'))
  }
}
...
function* onGetMessages({ roomId }) {
  try {
    ...
    yield put(getMessagesFail(error.message || error.toString() || 'An error occurred'))
  }
}
...
function* onAddMessage({ message }) {
  try {
    ...
    yield put(addMessageFail(error.message || error.toString() || 'An error occurred'))
  }
}
