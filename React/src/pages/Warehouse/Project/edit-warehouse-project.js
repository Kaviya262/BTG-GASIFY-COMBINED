...
const EditWarehouseProject = () => {
    ...
    useEffect(() => {
        if (location.state && location.state.projectData) {
            ...
            setFormData({
                id: projectData.id,
                autoNumber: projectData.autoNumber || "PJ000001",
                grnNumber: projectData.grnNumber || "",
                date: projectData.date || "",
                items: Array.isArray(projectData.items) ? projectData.items : (projectData.items ? [projectData.items] : []),
                quantity: projectData.quantity || "",
                projectNumber: projectData.projectNumber || "",
                description: projectData.description || "",
            });
        }
        document.title = "Edit Project Allocation | BTG Gas & Dashboard Template";
    }, [location]);
    ...
    const handleInputChange = (e) => {
        ...
        if (type === "select-multiple") {
            ...
            if (name === "grnNumber") {
                // Mock quantity update when GRN is selected
    ...
    return (
        <React.Fragment>
            <div className="page-content">
                <Container fluid>
                    <Breadcrumbs title="Warehouse" breadcrumbItem="Edit Project Allocation" />
