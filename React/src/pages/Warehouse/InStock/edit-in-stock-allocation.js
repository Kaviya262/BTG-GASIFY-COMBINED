  ...
  useEffect(() => {
    if (location.state && location.state.inStockData) {
      setFormData({
        ...
        autoNumber: location.state.inStockData.autoGeneratedNumber || "IS000001",
    ...
    document.title = "Edit In Stock Allocation | BTG Gas & Dashboard Template";
  }, [location]);
  ...
  return (
    <React.Fragment>
      <div className="page-content">
        <Container fluid>
          <Breadcrumbs title="Warehouse" breadcrumbItem="Edit In Stock Allocation" />
