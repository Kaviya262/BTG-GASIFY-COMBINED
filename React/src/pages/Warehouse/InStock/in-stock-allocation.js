...
const InStockAllocation = () => {
  ...
  const loadInStockData = async (from, to) => {
    setLoading(true);
    try {
      ...
      const mockData = [
        {
          id: 1,
          autoGeneratedNumber: "IS000001",
          date: "2024-01-10",
          glCode: "GL10001",
          itemName: "Cylinder storage",
          description: "GL10001-Cylinder storage",
          floor: "1",
          positionRack: "Left",
          rackNumber: "RACK-001",
          height: "Top",
        ...
        {
          id: 2,
          autoGeneratedNumber: "IS000002",
          date: "2024-01-11",
          glCode: "GL10003",
          itemName: "Valve storage",
          description: "GL10003-Valve storage",
          floor: "2",
          positionRack: "Right",
          rackNumber: "RACK-002",
          height: "Middle",
        ...
        {
          id: 3,
          autoGeneratedNumber: "IS000003",
          date: "2024-01-12",
          glCode: "GL10004",
          itemName: "Gauge storage",
          description: "GL10004-Gauge storage",
          floor: "1",
          positionRack: "Middle",
          rackNumber: "RACK-003",
          height: "Bottom",
        ...
        {
          id: 4,
          autoGeneratedNumber: "IS000004",
          date: "2024-01-13",
          glCode: "GL10002",
          itemName: "Safety equipment",
          description: "GL10002-Safety equipment",
          floor: "2",
          positionRack: "Left",
          rackNumber: "RACK-004",
          height: "Top",
      ...
      // toast.success("In Stock data loaded successfully");
    } catch (error) {
      console.error("Error loading data:", error);
      toast.error("Failed to load In Stock data");
    } finally {
      setLoading(false);
    }
  };
  ...
  const handleNew = () => {
    history.push("/warehouse/in-stock/add");
  };
  ...
  const handleExport = () => {
    ...
    try {
      ...
      element.setAttribute("download", `InStock_Export_${new Date().getTime()}.csv`);
      element.style.display = "none";
      document.body.appendChild(element);
      element.click();
      document.body.removeChild(element);

      toast.success("In Stock data exported successfully");
    } catch (error) {
      console.error("Error exporting data:", error);
      toast.error("Failed to export In Stock data");
    }
  };
  ...
  const handleSave = () => {
    try {
      ...
      console.log("Saving In Stock allocations:", updatedData);

      // Update the rows with the new allocation types
      setRows(updatedData);
      setEditingAllocation({});

      toast.success("In Stock allocations saved successfully");
    } catch (error) {
      console.error("Error saving data:", error);
      toast.error("Failed to save In Stock data");
    }
  };
  ...
  const handlePost = () => {
    try {
      ...
      console.log("Posting In Stock allocations:", updatedData);

      // Update the rows with the new allocation types and status
      setRows(updatedData);
      setEditingAllocation({});

      toast.success("In Stock allocations posted successfully");
    } catch (error) {
      console.error("Error posting data:", error);
      toast.error("Failed to post In Stock data");
    }
  };
  ...
  const handleEdit = (rowData) => {
    history.push(`/warehouse/in-stock/edit/${rowData.id}`, { inStockData: rowData });
  };
  ...
  document.title = "Warehouse In Stock Allocation | BTG Gas & Dashboard Template";
              ...
              <Card>
                ...
                {loading ? (
                  <div className="text-center p-5">
                    ...
                    <div className="mt-2 text-muted">Loading In Stock data...</div>
                  </div>
                ) : rows.length > 0 ? (
                  <>
                    <style>{`
                    ...
                    <DataTable
                      ...
                      loading={loading}
                      dataKey="id"
                      emptyMessage="No In Stock records found."
                      className="blue-bg"
                      style={{ width: "100%" }}
                    >
                      <Column
                        field="autoGeneratedNumber"
                        header="IS Number"
                  ...
                  <div className="alert alert-info mt-3 text-center">
                    <p className="mb-0">No In Stock records found. Please use the search filter to view data.</p>
                  </div>
                )}
              </Card>
            </Col>
            ...
            <table style={{ width: "100%", borderCollapse: "collapse", fontSize: "0.95rem" }}>
              <tbody>
                <tr style={{ borderBottom: "1px solid #e9ecef" }}>
                  ...
                  <td style={{ padding: "0.6rem 0.8rem" }}>{selectedDetail.autoGeneratedNumber}</td>
...
export default InStockAllocation;
