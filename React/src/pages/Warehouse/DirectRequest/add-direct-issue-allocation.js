...
const AddDirectRequestAllocation = () => {
  ...
  useEffect(() => {
    document.title = "Add Direct Issue | BTG Gas & Dashboard Template";
  }, []);
  ...
  return (
    <React.Fragment>
      <div className="page-content">
        <Container fluid>
          <Breadcrumbs title="Warehouse" breadcrumbItem="Add Direct Issue" />
...
export default AddDirectRequestAllocation;
