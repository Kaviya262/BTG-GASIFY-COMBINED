...
const DirectIssueAllocation = () => {
  ...
  const actionBodyTemplate = (rowData) => {
    return (
      <div className="d-flex align-items-center justify-content-center">
        ...
        >
          <i className="mdi mdi-pencil-box-outline" style={{ fontSize: "1.2rem" }}></i>
        </Button>
      </div>
    );
  };
  ...
  const issueStatusTemplate = (rowData) => {
    const severity = rowData.issueStatus === "Pending" ? "info" : "success";
    const displayText = rowData.issueStatus === "Pending" ? "I" : "P";
    return (
      <Badge color={severity} style={{ fontSize: "0.9rem", fontWeight: "bold" }}>
        {displayText}
      </Badge>
  ...
  document.title = "Warehouse Direct Issue | BTG Gas & Dashboard Template";
