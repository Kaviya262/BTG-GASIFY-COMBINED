...
const AddRequestAllocation = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    user: "Current User",
    date: "",
    requiredDate: "", // Common field for all items
    selectedItems: [],
  ...
  useEffect(() => {
    document.title = "Add Request | BTG Gas & Dashboard Template";
  }, []);
  ...
  return (
    <React.Fragment>
      <div className="page-content">
        <Container fluid>
          <Breadcrumbs title="Warehouse" breadcrumbItem="Add Request" />
            ...
            <Col lg="12">
              <Card>
                <CardBody>
                  ...
                  {!loading && (
                    <Form>
                      {/* Row 1: IR Number, Department, User, Required Date */}
                      <Row className="mb-3">
                        <Col lg="3">
                          <FormGroup>
...
export default AddRequestAllocation;
