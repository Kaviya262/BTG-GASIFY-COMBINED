            ...
            <Row>
              <Col lg="12">
                {this.props.error && this.props.error ? (
                  <Alert color="danger">{typeof this.props.error === 'string' ? this.props.error : this.props.error?.message || 'An error occurred'}</Alert>
                ) : null}
                {this.props.success && this.props.success ? (
                  <Alert color="success">{typeof this.props.success === 'string' ? this.props.success : this.props.success?.message || 'Success'}</Alert>
                ) : null}
